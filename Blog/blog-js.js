...
function menuTransfer() {
    ...
    if ($(window).width() <= 1199 && $(window).width() > 767) {
        $('.header__btn').after($menu);

    } else if ($(window).width() >= 1199) {
        $('.header__logo').after($menu);

    } else if ($(window).width() <= 767) {
        $('.dropdown-items').prepend($menu);
    }
}
...
// function portfolio() {
//     var $innerWrap = $('.portfolio__inner'),
//         $elemWrap = $('.portfolio__wrap-item'),
//         $elem = $('.portfolio__item'),
//         $elemTitle = $elemWrap.find('h3'),
//         tooltipRight = $elem.find('.portfolio-tooltip--text-right');
//
//     if ($(window).width() <= 1199) {
//         $innerWrap.prepend($elemTitle);
//
//         $elemWrap.parent().removeClass('portfolio__col');
//         $elemWrap.parent().addClass('portfolio__col--size');
//
//         $elemWrap.parent().each(function () {
//             if ($(this).index() > 2) {
//                 $(this).hide();
//             }
//         });
//
//         $elemWrap.each(function () {
//             var item = $(this).find('.portfolio__item');
//
//             if (item.length > 1) {
//                 item.last().hide()
//             }
//         });
//
//         tooltipRight.addClass('portfolio-tooltip--temporary');
//         $('.portfolio-tooltip--temporary').removeClass('portfolio-tooltip--text-right');
//     } else {
//         $elemWrap.first().prepend($innerWrap.find('h3'));
//         $elemWrap.parent().css('display', 'inline-block');
//         $elem.show();
//
//         $elemWrap.parent().removeClass('portfolio__col--size');
//         $elemWrap.parent().addClass('portfolio__col');
//
//         $('.portfolio-tooltip--temporary').addClass('portfolio-tooltip--text-right');
//         $('.portfolio-tooltip--temporary').removeClass('portfolio-tooltip--temporary');
//     }
// }
//
// portfolio();
...
//             $('.portfolio__inner').after($('<div class="portfolio__slider"></div>'));
//             $('.portfolio__wrap-item').clone().appendTo('.portfolio__slider');
//         }
//
//         $('.portfolio__inner').before($('.portfolio h3'));
//         $('.portfolio__inner').after($('.portfolio .services__more'));
//         $('.portfolio__inner').hide();
//
//         if ($('.portfolio__slider.slick-slider').length == 0) {
...
//         }
//
//         $('.portfolio__slider.slick-slider').after($('.portfolio .services__more'));
//
//     } else if ($(window).width() > 767 && $('.portfolio__slider.slick-slider').length != 0) {
//         $('.portfolio__inner').show();
//         $('.portfolio__inner').prepend($('.portfolio h3'));
//         $('.portfolio__slider').slick('unslick');
//         $('.portfolio__slider').remove();
//     }
// }
//
// portfolioSlider();
...
function servicesSlider() {
    if ($(window).width() <= 767) {
        $('.services__inner').after($('.services .services__more'));

        if ($('.services__inner.slick-slider').length == 0) {
            $('.services-block').wrap('<div class="services__slide"></div>');
    ...
    } else if ($(window).width() > 767 && $('.services__inner.slick-slider').length != 0) {
        $('.services-block:last').after($('.services .services__more'));
...
function dropdownItems() {
    if ($('.dropdown-items').length == 0) {
        $('.nav-toggle').after($('<div class="dropdown-items"></div>'));
    }

    if ($(window).width() > 767) {
        $('.header__logo').after($('.dropdown-item'));
    } else if ($(window).width() <= 767) {
        $('.dropdown-items').append($('.dropdown-item'));
    }
}
...
mainMenu('.dropdown-items', '.nav-toggle');
...
//     prevArrow: '<button type="button" class="billboard-slider__arrow billboard-slider__arrow--left"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="10.594" height="16" viewBox="0 0 10.594 16"><defs></defs><path d="M10.585,13.483 L8.013,15.990 L0.010,8.189 L0.205,8.000 L0.010,7.810 L8.013,0.009 L10.585,2.516 L4.960,8.000 L10.585,13.483 Z" class="cls-1"/></svg></button>',
//     nextArrow: '<button type="button" class="billboard-slider__arrow billboard-slider__arrow--right"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" width="10.59" height="16" viewBox="0 0 10.59 16"><path d="M10.581,8.189 L2.578,15.990 L0.006,13.483 L5.631,8.000 L0.006,2.516 L2.578,0.009 L10.581,7.810 L10.386,8.000 L10.581,8.189 Z" class="cls-1"/></svg></button>',
// })
// function tooltipHeight() {
//     $('.portfolio-tooltip').each(function () {
//         var $this = $(this),
//             $height = $this.height();
//         if ($height % 2 != 0) {
//             $height = $height - 1;
